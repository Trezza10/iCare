...
const EditPaymentMethod = () => {
	...
	const card = useSelector((state) => state.crmPatientDetails.state.selectedCard)
	const data = useSelector((state) => state.crmPatientDetails.data.paymentMethodData)
	const dialogOpen = useSelector((state) => state.crmPatientDetails.state.editPaymentMethodDialog)
	const selectedCard = useSelector((state) => state.crmPatientDetails.state.selectedCard)
