...
import PatientEditContent from './PatientEditContent'
import { useDispatch, useSelector } from 'react-redux'
import { setDrawerClose, setSelectedPatient } from '../store/stateSlice'
...
const PatientEditDialog = () => {
	...
	const drawerOpen = useSelector((state) => state.crmPatients.state.drawerOpen)
	...
	return (
		...
		>
			<PatientEditContent ref={formikRef} />
		</Drawer>
	)
}
