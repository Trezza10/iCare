...
export const helpCenterArticleListData = [
    ...
    },
    {
        ...
        content: 'If builders built buildings the way programmers wrote programs, then the first woodpecker that came along would destroy civilization. There are only two industries that refer to their patients as users',
        category: 'analytic',
        authors: [
            {
                name: 'Carolyn Hanson',
    ...
    {
        id: 'bd3Hxes4NB',
        title: 'Add new patient service on chatbot',
        content: 'It would appear that we have reached the limits of what it is possible to achieve with computer technology, although one should be careful with such statements, as they tend to sound pretty silly in 5 years. ',
        category: 'chatbot',
        authors: [
            {
    ...
    },
    {
        ...
        content: 'In software, we rarely have meaningful requirements. Even if we do, the only measure of success that matters is whether our solution solves the patients shifting idea of what their problem is. The best method for accelerating a computer is the one that boosts it by 9.8 m/s2',
        category: 'commission',
        authors: [
            {
                name: 'Lee Wheeler',
